...
Developed by [AmberCode](https://github.com/AmberCode), this plugin provides deep insights into players' mining behaviors to determine if they are **legitimately playing** or exploiting **xray hacks**.
...
1. Clone the repository in a terminal using `git clone https://codeberg.com/AmberCode/XRayDetector.git`. 
